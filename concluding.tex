...
with easy elictitation and computation.
More verbosely***,
\begin{itemize}
\item they are relatively easy to elicit:
there is a simple and straightforward interpretation of the model parameters,
the weighted average structure of the update step and the model behaviour resulting from it is relatively clear;
\item they are easy to apply:
...
\item and they allow flexible modelling:
it is possible to choose or tweak the prior set shape according to the current needs.
\end{itemize}
