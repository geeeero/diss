...
or different sorts of neighbourhood models as considered in robust Bayesian approaches. ***citations?*** %\parencite[e.g.,][]{1994:berger}.
...
a set of (prior) distributions on $\vartheta$ by %$\mathcal{M}_{l,u}$ by 
...
The density ratio class is a special case of the credal sets discussed in Section~\ref{sec:ip-main}
...
**** are not closed under Bayesian updating.

***\cite{2011:rinderknecht}

IP gives thus a formal framework for robust Bayesian inference models.
...
We agree with \textcite[\S 1.1]{1990:berger} in the view that there are very strong foundational arguments
...
in judgement about unknowns and utilities'' \parencite[p.~303]{1990:berger}. 
