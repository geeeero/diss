...
The fundamental motive at play in expert systems and the in the study of uncertainty in artificial intelligence
in general ***cite journal?*** is that usual probability measures
...
(NPI, see ****), where minimal model assumptions (based on exchangeability of observations)
lead to a nonparametric model supplying lower and upper probability bounds for arbitrary events.
A striking application of this theory is a nonparametric generalisation of the
Nelson-Aalen estimator for survival functions **cite****,
which effectively expresses the uncertainty inherent in the estimation
by lower and upper bounds **cite***.}
...
\item The provision of basic tools generalising probability measures,
...
A fastly growing literature, especially in econometrics,
is devoted to an approach along these lines, called \emph{partial identification} ***cite manski***.
...
strictly fulfilled as necessary for the classical theory.***rephrase***
\end{enumerate}


***now risk versus ambiguity, also ip=probability+modal logic?***
...
\section{***Other Models Based on Sets of Priors***}
