...
We will first introduce lower previsions and the most important rationality requirements
guiding their set-up and use***,
then have a brief look at sets of desirable gambles as the most comprehensive formulation.
Sets of probability distributions, as the formulation used to describe inference models in this theses***,
are then explained in relation to the other formulations,
and the generalised Bayesian inference procedure as used in Section~\ref{sec:imprecise-alpha} is justified.
...
Illustration of \underline{E}\ and $\Eu$ as supreme buying and infimum selling prices for a gamble $X$ on a linear utility scale.}
...
***unusual, but mathematically convenient formulation,
also expressable as partial preference orderings.

***more general than lower previsions,
but detailed account not necessary for this thesis
