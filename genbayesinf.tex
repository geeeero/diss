...
(see the short describtion in Section~\ref{sec:hierarchical}),
...
see \parencite[\S 5]{itip-statinf}***
...
\parencite[\S 3]{2007a:cattaneo} ***or other ref***.
In contrast, in the fuzzy literature, the interpretation of fuzzy numbers, or membership functions,
