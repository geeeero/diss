...
The two equivalences below are known as the \emph{lower envelope theorem} \cite[\S 3.3.3]{1991:walley}.
\begin{enumerate}[(a)]
...
there is nothing in the theory preventing us to consider open or non-convex sets $\mathcal{M}$ as the initial assessment,
because lower and upper previsions derived from $\mathcal{M}$ are automatically coherent.
