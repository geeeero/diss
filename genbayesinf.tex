...
may expresse naturally that the accumulating information is non-conflicting and stable.%
...
We will breifly discuss here some critique on imprecise probability methods,
and touch on some suggested alternative models.***

It is often argued that imprecise probability methods are more difficult to apply,
...
(e.g., lower previsions are indeed more complex than linear previsions or precise probability distributions),
we believe that increased effort in modeling and application (if there is any substantial)
...
in contrast to the seemingly precise results that are characteristic for many precise methods,
which are often obtained due to a multitude of, often heroic, model assumptions. %***footnote or par on manski?***
...
Taking aside the problematic assumption of `continuity' of statistical procedures inherent in this thinking,%
...
is, in the subjective Bayesian inference paradigm, often non-existent.
Here, prior probabilities must be elicited,
...
that eliciting two numbers instead of one must be more difficult as a misconception.%
...
models for Bayesian inference with imprecise proability
that are practicable and implement the modelling opportunities discussed.*** % the motives discussed
