...
There are many links to other concepts that aim to complement probability theory as tool for handling uncertainty.
like possibilistic reasoning, fuzzy (probability) measures (also known as capacities),
different sorts of neighbourhood models, etc. (itip-ch.\ 5,6)

many can be seen as special cases of lower previsions
or sets of probability distributions,
i.e., restricted versions of them. (itip-ch.\ 5,6)

nevertheless useful, as more easy to handle, elicit,
more easy to understand.

some concepts are used in a way that does not warrant
the step beyound precise probability distributions.
