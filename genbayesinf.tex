...
we first want to point out a very fundamental motive for the use of imprecise probability methods,
...
A more detailed discussion on the issue prior-data conflict will be given in Section~\ref{sec:motivation:pdc}.
