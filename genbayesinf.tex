...
Then, it is better to acknowledge indecision,
instead of hiding it, as---if it must---a decision can be made nevertheless,
in the same arbitrary way as with a spuriously precise method
\parencite[\S 5.7]{1991:walley}.

Although precise Bayesian methods will be adequate in many inference settings,
...
\footnote{See a simple illustration of this in \parencite[\S 5.8, footnote~7, p.~535]{1991:walley}.}
