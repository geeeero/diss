...
In the literature the seemingly self-evident character of the Generalized Bayes Rule has been questioned.
Indeed, \textcite[p.~335]{1991:walley} notes that, although the theory of coherence suggests that
...
***conditioning versus belief revision***

Firstly, it has been shown that the decision theoretic justification of the Bayes' Rule
as producing prior risk minimizing decision functions does not extend to the case of sets of priors.
...
Secondly, it has been debated that---intuitively---in the case of no prior-data conflict
the resulting interval limits may be too wide, and in this sense posterior inferences are too imprecise.
Such possibly counterintuitive bounds result from elements in the prior credal set under which the observed sample is rather unlikely.
In order to maintain the understanding of updating as conditioning on the sample,
several authors therefore suggested to reduce the prior sets in dependence on the sample.
A radical way to achieve this is to consider in the conditioning process only those priors
under which the observed sample has highest probability, e.g., \textcite{2007:held}, see also \textcite{1982:walley},
...
\parencite{1993:coolen, 1994:coolen}, see also \textcite{1994:coolen::phd} or hierarchical models,
like the model suggested by \textcite{2008:cattaneo} in the (profile) likelihood context (see the short note in Section~****),
...
***end with stressing that work here relies on GBR nevertheless.***
