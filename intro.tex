...
\subsection{Ususal Handling Epistemic Information for Alpha-Factors}
...
By means of an example, taken from Kelly and Atwood \cite{2011:kelly:atwood},
...
Therefore, we will argue that bounds, rather than precise values,
should be assigned for these hyperparameters, and that in this application,
...
Atwood \cite{1996:atwood} studied priors for the binomial model
...
Atwood \cite{1996:atwood} showed that they can be well approximated by Beta distributions, which are conjugate.
%
Kelly and Atwood \cite{2011:kelly:atwood} applied this approach to the multinomal model with conjugate Dirichlet priors,
...
\end{align*}
Kelly and Atwood \cite[p.~402, \S 4]{2011:kelly:atwood}
