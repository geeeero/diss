...
Here, we first study the class of imprecise probability models
of type~(\ref{enum:modeltypes-a}) from the framework established in Section~\ref{sec:basicsetting} (see p.~\pageref{enum:rectangular}).
As mentioned there, this type of models includes the Imprecise Dirichlet Model \parencite[IDM,][]{1996:walley::idm} under prior information,
and more generally the framework of \textcite{2005:quaeghebeurcooman} for imprecise inference in
...
extent of prior-data conflict. We then propose an extension,
namely by employing prior parameter sets of type~(\ref{enum:rectangular}),
that reestablishes the natural relationship between knowledge and
...
neglected by the traditional concept of probability.
Specifically, imprecise probability models allow to explicitely reflect the amount of knowledge they stand for,
and thus promise to offer a vivid tool for
handling situations of prior-data conflict in (generalised) Bayesian inference.

The most common --- closely related --- mathematical tools in the theory of imprecise probability are
...
%throughout *this Section* when we speak of \emph{generalised Bayesian inference}.
...
As shown by \textcite{Walter2006a}, \textcite{Walter2007a}, and \textcite{Walter2007b},
...
%at Section~\ref{sec:jstp-intro},% %*paper intro* %\ref{sec:intro},
