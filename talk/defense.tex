...
\note<4>[item]{why conjugate priors? easy to calculate, posterior tractable (known family)}
}
...
\note<3>[item]{So this must be included in overall systems reliability analysis}
\note<3>[item]{This lesson was learned at another accident at a nuclear power station, \play\ }
}
...
\begin{frame}{Imprecise Dirichlet Model: Elicitation}
  ...
  \end{alertblock}}
\note<3>[item]{choice of bounds for $\nzg$ is not so straight-forward,
