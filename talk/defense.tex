...
\item<3-> $\PZc\! = [\nzlg,\nzug] \times [\yzlr, \yzur]$ {\small (Walley 1991; Walter \& Augustin 2009)}:\\
 ...
 implementation: \hyperlink{luck-app}{\textbf{R} package \texttt{luck}}
% \end{itemize}
...
\begin{frame}[label=noninf-app]{So-called Noninformative Priors \hyperlink{noninf-back<3>}{\beamerreturnbutton{}}}
\begin{itemize}
\item noninformative priors can be useful as a technical device if data are non-sparse***
\item in contrast to the name they do contain substantial information:\\
...
\item instead, a set of priors with $P(A) = [0,1]$ is noninformative
