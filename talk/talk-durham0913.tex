...
\pause
\hspace*{6ex}\parbox[t]{0.9\textwidth}{\textbf{add \alert{imprecision} as new model dimension:\\
...
%\vspace*{-7ex}%
\begin{center}
\includegraphics[trim = 15mm 45mm 25mm 60mm, clip, width=\textwidth]{../R/boatshape-durham0913} %[scale=0.63]
\end{center}}
