...
\begin{itemize}[<+->]
\item Conjugate priors are a convenient tool for Bayesian inference\\ but there are some pitfalls
 \begin{itemize}[<+->]
 ...
 \end{itemize}
\item Sets of conjugate priors maintain advantages \& mitigate issues %find a sweet spot in between
 \begin{itemize}[<+->]
