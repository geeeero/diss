...
% \begin{center}
 ...
 %\end{minipage}
 %\end{center}
\item Reliability of redundant systems
\item Usually 2 -- 4 emergency diesel generators per reactor
...
\frame{\frametitle{Set of Priors can be Convex}
...
but useful only for inferences that are \emph{linear} in the posteriors\\
...
\item<4-> \emph{Near-ignorance priors}: $\PZc$ such that prior inferences are \emph{vacuous},
